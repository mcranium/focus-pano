...
def load_relight_lp(filename=None):
    """
    This is a function which is equivalent to the load_lighttxt function but is tailored to the light point file format of relight.
    """
    if filename is None:
        raise ValueError("filename is None")
